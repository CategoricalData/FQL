...
public class ThueSlow<Y> {
	 ...
	 *
	 * @param s this parameter is ignore, but required to make sure users read the document to note Hat this is not a true normal form
...
//		check_oriented(rules);
   ...
   //         normalize(t);
         //   cp(t); //has side effect, more Han just orient
            return false;
